...
public class EditTextUtils {
	...
	public EditTextUtils(EditText mEditText, int MAX_COUNT, TextView mTextView) {
	...
	private TextWatcher mTextWatcher = new TextWatcher() {
		...
		public void afterTextChanged(Editable s) {
			...
			while (calculateLength(s.toString()) > MAX_COUNT && editStart>MAX_COUNT) { // 当输入字符个数超过限制的大小时，进行截断操作

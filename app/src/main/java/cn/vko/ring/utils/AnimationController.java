...
public class AnimationController
{
	...
	public void slideTopIn(View view, long durationMillis, long delayMillis){
...
//		animation.addAnimation(animation2);
	...
	public void slideSelfTopIn(View view, long durationMillis, long delayMillis){
...
//		animation.addAnimation(animation2);
	...
	public void slideTopOut(View view, long durationMillis, long delayMillis){
...
//		animation.addAnimation(animation2);
	...
	public void slideButtomIn(View view, long durationMillis, long delayMillis){
		TranslateAnimation animation1 = new TranslateAnimation(rela2,0, rela2, 0, rela2, 1, rela2, 0);
//		AlphaAnimation animation2 = new AlphaAnimation(0, 1);
		AnimationSet animation = new AnimationSet(false);
		animation.addAnimation(animation1);
//		animation.addAnimation(animation2);
	...
	public void slideButtomOut(View view, long durationMillis, long delayMillis){
		TranslateAnimation animation1 = new TranslateAnimation(rela2, 0, rela2, 0, rela2, 0, rela2, 1);
//		AlphaAnimation animation2 = new AlphaAnimation(1, 0);
		AnimationSet animation = new AnimationSet(false);
		animation.addAnimation(animation1);

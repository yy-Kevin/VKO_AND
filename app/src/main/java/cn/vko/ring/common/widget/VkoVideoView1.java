 ...
 *
 */
public class VkoVideoView1 extends IjkVideoView implements VkoMediaController.OnVideoChangeListener,
     ...
     * @param attrs
     */
    public VkoVideoView1(Context context, AttributeSet attrs) {
        super(context, attrs);

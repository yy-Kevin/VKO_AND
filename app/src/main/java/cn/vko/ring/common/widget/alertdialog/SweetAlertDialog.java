package cn.vko.ring.common.widget.alertdialog;
...
import cn.vko.ring.common.widget.dialog.ProgressWheel;
...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
	...
	private OnSweetClickListener mDismissClickListener;
	...
	public SweetAlertDialog(Context context, int alertType) {
		...
		// mErrorXInAnim =
		// (AnimationSet)OptAnimationLoader.loadAnimation(getContext(),
		// R.anim.error_x_in);
	...
	public boolean isShowDissmissButton() {
		return mShowDismiss;
	}

	public boolean ismShowConfim() {
		return mShowConfirm;
	}

	public void setmShowConfim(boolean mShowConfim) {
		this.mShowConfirm = mShowConfim;
	}
	...
	public SweetAlertDialog showDismissButton(boolean isShow) {
		mShowDismiss = isShow;
		if (mDismissButton != null) {
			mDismissButton.setVisibility(mShowDismiss ? View.VISIBLE
					: View.GONE);
		}
		return this;
	}
	...
	public SweetAlertDialog setDismissText(String text) {
		mDismissText = text;
		if (mDismissButton != null && mDismissText != null) {
	...
	public SweetAlertDialog setDismissClickListener(
			OnSweetClickListener listener) {
		mDismissClickListener = listener;
		return this;
	}
	...
	public void onClick(View v) {
		...
		} else if (v.getId() == R.id.dismiss_button) {
			if (mDismissClickListener != null) {
				mDismissClickListener.onClick(SweetAlertDialog.this);
			} else {
				dismissWithAnimation();
			}
		}

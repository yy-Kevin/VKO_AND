 ...
 * 
 */
public class GroupVideoViewActivity extends BaseActivity implements
	...
	private void initStartPlay() {
		// TODO Auto-generated method stubgetVideoData();
	...
	private void showAlerDialogNet() {
		...
		if (dialog == null) {
			...
			dialog.setConfirmClickListener(new OnSweetClickListener() {
				...
				public void onClick(SweetAlertDialog sweetAlertDialog) {
					// TODO Auto-generated method stub
					Intent intent = new Intent(GroupVideoViewActivity.this,

 ...
 */
public class CourseGroupListAdapter extends BaseListAdapter<CourseMsg> {


    public CourseGroupListAdapter(Context ctx) {
        super(ctx);
    }
    ...
    @Override
    protected void fillView(View root, CourseMsg item, ViewHolder holder, int position) {

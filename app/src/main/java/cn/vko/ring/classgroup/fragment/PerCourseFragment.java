...
import cn.vko.ring.classgroup.adapter.CourseListAdapter;
 ...
 */
public class PerCourseFragment extends MainTabFragment implements CourseListView, XListView.IXListViewListener, AdapterView.OnItemClickListener {
    ...
    public void setContainerId(int containerId) {
        this.setContainerId(CourseTab.PER_COURSE.fragmentId);
    }
    @Override
    ...
    private void getData() {
        presenter.getCourseList("4", pageIndex, pageSize);
    }

...
public class TaskAttachment extends CustomAttachment {
    ...
    CourseMsg course;
    private static final String TAG = "TaskAttachment";
    ...
    public TaskAttachment(){
        super(CustomAttachmentType.TASK);
    }

    public TaskAttachment(int type, CourseMsg course) {
        super(type);
        this.course = course;
    }
    public TaskAttachment(JSONObject data){
        super(CustomAttachmentType.TASK);
//       parseData(data);
    }

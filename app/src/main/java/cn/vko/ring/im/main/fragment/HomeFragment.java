...
import cn.vko.ring.im.main.adapter.MainTabPagerAdapter;
import cn.vko.ring.im.main.helper.SystemMessageUnreadManager;
import cn.vko.ring.im.main.model.MainTab;
...
public class HomeFragment extends TFragment implements OnPageChangeListener, ReminderManager.UnreadNumChangedCallback {
    ...
    private void setupPager() {
        // CACHE COUNT
        adapter = new MainTabPagerAdapter(getChildFragmentManager(), getActivity(), pager);

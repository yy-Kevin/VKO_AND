 ...
 * 
 * 同步课程适配器
 * @author 谢雷 Administrator
 * 谢雷  Create at 2015-11-26 下午3:52:38
 */
public class MyCourseSectionAdapter extends BaseListAdapter<TonBuCourseSection> {
...
//	private DisplayImageOptions options;
	...
	public MyCourseSectionAdapter(Context ctx) {
		super(ctx);
		this.context = ctx;
	}
	...
	@Override
	protected void fillView(View root, TonBuCourseSection item,
			ViewHolder holder,
			int position) {
		if (item == null) {
			return;

...
import cn.vko.ring.home.activity.MyServiceProtocolActivity;
import cn.vko.ring.study.activity.ThousandCityActivity;
...
//	private MyLocationListener mMyLocationListener;
	...
	private TextView thousand_city;
...
//					Log.e("===成功移除","===");
//					Log.e("所有城市",allCity_lists.get(position).getName());
		...
		resultList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Toast.makeText(getApplicationContext(),
						...
						.show();
//				Log.e("城市结果",city_result.get(position).getName());
				Intent intent=new Intent();
...
//			Log.e("info", "length = " + cursor.getCount());
	...
	private class TextViewURLSpan extends ClickableSpan {
		...
		public void onClick(View widget) {// 点击事件
			Intent intent = new Intent(getApplicationContext(), ThousandCityActivity.class);
			startActivity(intent);
			thousand_city.setHighlightColor(getResources().getColor(
					R.color.transparent));
		}
	}
...
//			return position < 4 ? position : 4;
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (viewType == 0) { //
				...
				city = (TextView) convertView.findViewById(R.id.location_city);
				city.setText(locationCity);
				thousand_city = (TextView) convertView.findViewById(R.id.thousand_city);
				sProtocol = (String) getResources().getText(R.string.thousands_citsy);
				SpannableStringBuilder style = new SpannableStringBuilder(sProtocol);
				TextViewURLSpan myURLSpan = new TextViewURLSpan();
				style.setSpan(myURLSpan, 0, 10, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
				thousand_city.setText(style);
				thousand_city.setMovementMethod(LinkMovementMethod.getInstance());

				city.setOnClickListener(new View.OnClickListener() {
					@Override
					public void onClick(View v) {
//							Log.e("城市定位",locationCity+"==");
						Toast.makeText(getApplicationContext(),
			...
			if (viewType == 1) {
				...
				hotCity.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
											int position, long id) {
//						Log.e("城市热门",city_hot.get(position).getName());
						Toast.makeText(getApplicationContext(),

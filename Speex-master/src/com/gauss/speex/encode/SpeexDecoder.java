...
//							track.setStereoVolume(0.7f, 0.7f);// ���õ�ǰ������С
							track.play();
//							for(ProgressListener l : listenerList){
//								progress += decsize;
//							}
						}
						packetNo++;
	...
	private IAudioCompleteListener listener;
	public void setOnCompleteListener(IAudioCompleteListener listener){

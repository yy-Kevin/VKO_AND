...
public final class CameraManager {
	...
	private static final int MIN_FRAME_WIDTH = 360;//240;
	private static final int MIN_FRAME_HEIGHT = 360;//240;
	private static final int MAX_FRAME_WIDTH = 600;//400;
	...
	public Rect getFramingRect() {
		if (framingRect == null || configManager == null) {
			if (camera == null) {
				return null;
			}

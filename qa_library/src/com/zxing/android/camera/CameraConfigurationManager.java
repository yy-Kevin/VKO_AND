...
//		cameraResolution = findBestPreviewSizeValue(parameters,r , width);
	...
	private static Point findBestPreviewSizeValue(Camera.Parameters parameters, float th,int minWidth) {
		Size s = CamParaUtil.getInstance().getPropPreviewSize(parameters.getSupportedPreviewSizes(), th, minWidth);

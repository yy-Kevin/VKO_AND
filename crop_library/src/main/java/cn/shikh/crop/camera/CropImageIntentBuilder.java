...
public class CropImageIntentBuilder {
	...
	private static final String EXTRA_SQUARE_CROP = "squareCrop";
	...
	private boolean squareCrop = false;
	...
	public Intent getIntent(final Context context) {
		...
		intent.putExtra(EXTRA_SQUARE_CROP, this.squareCrop);
	...
	/**
	 * Set the quality for the output file when applicable. This is used for
	 * JPEG output format for example.
	 * 
	 * @param outputQuality
	...
	public CropImageIntentBuilder setSquareCrop(final boolean squareCrop) {
